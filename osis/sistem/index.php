  ...
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
      ...
      <head>
        ...
        <title>E-Voting OSIS SMK Negeri 8 Semarang</title>
        <link rel="icon" href="assets/img/logo-smkn8.png" />
        <!---------------------------------------------------------------------->
        ...
        <div class="adjust-nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
              <h4 style="color: white;">E-Voting OSIS</h4>
            </a> 
          </div>
...
<!--                 <li>
          ...
          <div class="row">
            <div class="col-lg-12 ">
              <div class="alert alert-info">
                <strong><h2><b>Selamat datang</b></h2></strong><b style="font-size: 18px;"><?php echo $_SESSION['nama_mhs']; ?></b> , di Pemilihan Ketua dan Wakil Ketua OSIS SMK Negeri 8 Semarang Periode 2021-2022
              </div>   
            </div>
          </div>
                    ...
                    while($d = mysqli_fetch_array($data_paslon)){
                      ...
                      <div class="col-lg-5">
                        <table class="table table-striped table-bordered table-hover">
                          ...
                          <tr>
                            <td><img style="width: 100%; height: auto" src="<?php echo "foto/".$d['gambar1']; ?>"></td>
                          </tr>
                          <tr>
                            <td align="center" colspan="2"><h2><?php echo $d['nm_paslon_ketua']; ?></h2> <br> <h2><?php echo $d['nm_paslon_wakil']; ?></h2></td>
                          </tr>
                          <tr>
  ...
  <div class="footer">
    <div class="row">
      <div class="col-lg-12" >
        SMK Negeri 8 Semarang <?php echo date('Y') ?> <a href="http://binarytheme.com" style="color:#fff;" target="_blank"></a>
      </div>
    </div>
  </div>
