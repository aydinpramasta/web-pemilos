  ...
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
      ...
      <head>
        ...
        <title>E-Voting MPK SMK Negeri 8 Semarang</title>
        ...
        <div class="adjust-nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
              <h4 style="color: white;">E-Voting MPK</h4>
            </a> 
          </div>
          ...
          <div class="row">
            <div class="col-lg-12 ">
              <div class="alert alert-info">
                <strong><h2><b>Selamat datang</b></h2></strong><b style="font-size: 18px;"><?php echo $_SESSION['nama_mhs']; ?></b> , di Pemilihan Ketua dan Wakil Ketua MPK SMK Negeri 8 Semarang Periode 2021-2022
              </div>   
            </div>
          </div>
